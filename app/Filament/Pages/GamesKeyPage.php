...
class GamesKeyPage extends Page implements HasForms
{
    ...
    protected static ?string $title = 'PROVEDOR ANDERSON API';
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('Provedor Anderson')
                        ...
                        <div style="display: flex; align-items: center;">
                            ...
                            <a class="dark:text-white" 
                               style="
                                   ...
                                   margin-left: 10px;
                               " 
                               href="https://provedoranderson.com" 
                               target="_blank">
                                Recarregar API
                            </a>
                            <a class="dark:text-white" 
                               style="
                                   ...
                                   margin-left: 10px;
                               " 
                               href="https://t.me/provedoranderson" 
                               target="_blank">
                                Suporte ao cliente
                            </a>
                        </div>
                    '))
                    ->schema([
                        TextInput::make('provedoranderson_url')
                            ->label('URL')
                            ->placeholder('Digite aqui a URL')
                            ->maxLength(191),
                        TextInput::make('provedoranderson_secret')
                            ->label('Agent Secret')
                            ->placeholder('Digite aqui o código secreto do agente')
                            ->maxLength(191),
                        TextInput::make('provedoranderson_code')
                            ->label('Agent Code')
                            ->placeholder('Digite aqui o código do agente')
                            ->maxLength(191),
                        TextInput::make('provedoranderson_token')
                            ->label('Agent Token')
                            ->placeholder('Digite aqui o token do agente')
                            ->maxLength(191),
                        TextInput::make('provedoranderson_rtp')
